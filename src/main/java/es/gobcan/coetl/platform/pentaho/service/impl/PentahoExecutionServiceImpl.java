package es.gobcan.coetl.platform.pentaho.service.impl;
...
import es.gobcan.coetl.platform.pentaho.web.rest.dto.WebResultDTO;
...
public class PentahoExecutionServiceImpl implements PlatformExecutionService {
    ...
    public PentahoExecutionServiceImpl(PentahoProperties pentahoProperties, ExecutionService executionService, ParameterService parameterService,
                                       MessageSource messageSource, MailService mailService, UsuarioService usuarioService, GitService pentahoGitService) {
    ...
    private WebResultDTO buildErrorConnectionServerWebResult() {
        ...
        errorWebResultDTO.setResult(es.gobcan.coetl.platform.pentaho.web.rest.dto.WebResultDTO.Result.ERROR);
        errorWebResultDTO.setMessage(messageSource.getMessage("execution.note.error.server.pentaho.connection", null, Constants.DEFAULT_LOCALE));
